      ...
      <div className="max-w-7xl mx-auto px-2 xs:px-3 sm:px-4 md:px-8 lg:px-12">
        <div className="flex items-center justify-between h-12 xs:h-14 sm:h-16 md:h-18">
          ...
          >
            ...
            <span className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-white group-hover:text-blue-600 transition-colors duration-200 truncate">
              DocGen
            </span>
          </Link>
          ...
          <div className="flex items-center space-x-1 xs:space-x-2 sm:space-x-3 md:space-x-4 flex-shrink-0">
            ...
            <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
              <a
                href="#features"
                className="text-sm lg:text-base text-gray-200 hover:text-blue-400 transition-colors duration-200 font-medium whitespace-nowrap"
              >
                Features
              </a>
              <a
            ...
            <div className="md:hidden">
              <button
                ...
                className="text-gray-200 p-1.5 xs:p-2 hover:bg-gray-800 rounded-lg transition-colors duration-200 flex-shrink-0"
              >
                {isMenuOpen ? (
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out ${
        ...
        <div className="bg-gray-900 border-t border-gray-800 shadow-lg">
          <div className="px-2 xs:px-3 sm:px-4 md:px-6 pt-2 pb-3 space-y-1">
            <a
              href="#features"
              className="block px-2 xs:px-3 py-2 xs:py-3 text-sm xs:text-base font-medium text-gray-200 hover:text-blue-400 hover:bg-gray-800 rounded-md transition-colors duration-200"
